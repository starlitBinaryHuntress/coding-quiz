...
var questions = ['Which of the following pseudo-classes would you use in CSS to change the class of an element while the mouse is over it?', 'Which HTML element contains the text that goes on the tab above the webpage?', 'Which of the following is a way to store groups of data into a single variable?', 'How do you halt event bubbling?']
...
startBtn.addEventListener("click", () => {startTimer(); hideStartPage(); showNextQuestion ()})
